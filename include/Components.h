...
enum Components {
    ...
    SYN_COMPONENT_PHYSICS_JOINT = 16384,
    SYN_COMPONENT_TERRAIN       = 32768 | SYN_COMPONENT_MESH |
                            SYN_COMPONENT_TRANSFORM | SYN_COMPONENT_RIGIDBODY,
    SYN_COMPONENT_DEBUG         = 65536,
