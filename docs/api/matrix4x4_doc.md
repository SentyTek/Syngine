...
4x4 matrix class for mathematical operations in 3D space
...
- [Matrix4x4(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float m20, float m21, float m22, float m23, float m30, float m31, float m32, float m33)](#matrix4x4-matrix4x4float-m00-float-m01-float-m02-float-m03-float-m10-float-m11-float-m12-float-m13-float-m20-float-m21-float-m22-float-m23-float-m30-float-m31-float-m32-float-m33)
- [Matrix4x4(const float* elements)](#matrix4x4-matrix4x4const-float-elements)
- [Matrix4x4(const Vector3& scale, const Quaternion& rot, const Vector3& translation)](#matrix4x4-matrix4x4const-vector3-scale-const-quaternion-rot-const-vector3-translation)
- [Matrix4x4(const Matrix4x4& other)](#matrix4x4-matrix4x4const-matrix4x4-other)
- [Matrix4x4(Matrix4x4&& other)](#matrix4x4-matrix4x4matrix4x4-other)
...
- [setRow()](#matrix4x4-setrow)
- [setColumn()](#matrix4x4-setcolumn)
- [data()](#matrix4x4-data)
- [data()](#matrix4x4-data-2)
- [getTranslation()](#matrix4x4-gettranslation)
- [nodiscard()](#matrix4x4-nodiscard)
- [transpose()](#matrix4x4-transpose)
- [invert()](#matrix4x4-invert)
- [nodiscard()](#matrix4x4-nodiscard-2)
- [determinant()](#matrix4x4-determinant)
- [isInvertible()](#matrix4x4-isinvertible)
- [isIdentity()](#matrix4x4-isidentity)
...
---
<a id="matrix4x4-matrix4x4float-m00-float-m01-float-m02-float-m03-float-m10-float-m11-float-m12-float-m13-float-m20-float-m21-float-m22-float-m23-float-m30-float-m31-float-m32-float-m33"></a>
...
---
<a id="matrix4x4-matrix4x4const-float-elements"></a>
...
---
<a id="matrix4x4-matrix4x4const-vector3-scale-const-quaternion-rot-const-vector3-translation"></a>

## Class Constructor

#### **`Matrix4x4(const Vector3& scale, const Quaternion& rot, const Vector3& translation)`**
...
---
<a id="matrix4x4-matrix4x4const-matrix4x4-other"></a>
...
---
<a id="matrix4x4-matrix4x4matrix4x4-other"></a>
...
---
<a id="matrix4x4-gettranslation"></a>
